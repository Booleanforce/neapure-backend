...
class AdminTechnicianViewSet(viewsets.ModelViewSet):
    ...
    Endpoints:
        ...
        POST    /api/technicians/admin/technicians/
        GET     /api/technicians/admin/technicians/{id}/
        PATCH   /api/technicians/admin/technicians/{id}/
        PUT     /api/technicians/admin/technicians/{id}/
        DELETE  /api/technicians/admin/technicians/{id}/
    """
    ...
    def create(
        ...
        **kwargs
        ...
        # Generate temporary Firebase UID
    ...
    def destroy(
        ...
        **kwargs
        ...
        deleted_id = str(technician.id)
        deleted_email = technician.email
        deleted_name = technician.full_name
        ...
        # ------------------------------------------------------------------
        # IMPORTANT:
        # Use QuerySet.delete() instead of instance.delete().
        #
        # This bypasses a custom User.delete() implementation that may
        # perform a soft delete instead of physically removing the row.
        # ------------------------------------------------------------------
        ...
        still_exists = User.objects.filter(
            pk=technician.id
        ).exists()
...
class OperationAdminJobViewSet(
    ...
    """
    API for Operations Admin to assign
    and manage technician jobs.
    """
...
# ============================================================================
# OPERATION ADMIN TECHNICIAN PERFORMANCE
# ============================================================================
...
class OperationAdminTechnicianViewSet(
    ...
    """
    API for Operations Admin to view
        ...
        return (
            ...
            .annotate(
                ...
                cancelled_jobs=Count(
                    "assigned_jobs",
                    filter=Q(
                        assigned_jobs__status="CANCELLED"
                    ),
                ),
                avg_rating=Avg(
            ...
            data.append(
                {
                    ...
                    "email": tech.email,
                    "status": (
                        tech.technician_profile.status
                        if hasattr(
                            tech,
                            "technician_profile"
                        )
...
class TechnicianMyJobsViewSet(
    ...
    """
    API for Technicians to view
    and update their own jobs.
    """
